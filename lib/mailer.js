...
function _sup() { return process.env.SMTP_USER || 'info@fwfindia.org'; }
...
function _footer(accent = '#E87722') {
  return `<div style="background:#f8fafc;border-top:4px solid ${accent};padding:24px 32px;text-align:center;font-family:Arial,sans-serif">
    ...
    <p style="margin:0;font-size:12px;color:#9ca3af">© ${new Date().getFullYear()} Foundation for Women's Future · <a href="${SITE}" style="color:${accent}">fwfindia.org</a></p>
  </div>`;
}
...
<table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%">
  ...
  <tr><td style="background:#fff;padding:32px">
    ...
    <p style="margin:0 0 24px;font-size:15px;color:#6b7280;line-height:1.6">Welcome to the <strong>Foundation for Women's Future</strong> family! Your membership has been successfully activated. Below are your login credentials — please keep them safe.</p>
    <!-- Credentials box -->
